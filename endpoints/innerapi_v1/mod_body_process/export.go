...
// ExportAction exports mod_body_process configuration
...
func exportActionProcess(req *http.Request) (interface{}, error) {
	...
	return container.ModBodyProcessManager.ConfigExport(req.Context(), param.Version)
}
