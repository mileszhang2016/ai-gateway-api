...
6. **Entity / RateLimit / Quota 相关存储与 Manager**：在 `model/entity`、`model/rate_limit_policy`、`model/quota` 中分别初始化 EntityType、Entity、RateLimitPolicy、QuotaPlan、RouteRules 及其 Manager。
